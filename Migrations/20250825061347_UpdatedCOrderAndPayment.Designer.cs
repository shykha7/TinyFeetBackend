...
namespace TinyFeetBackend.Migrations
{
    ...
    [Migration("20250825061347_UpdatedCOrderAndPayment")]
    partial class UpdatedCOrderAndPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TinyFeetBackend.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TinyFeetBackend.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TinyFeetBackend.Entities.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TinyFeetBackend.Entities.OrderItem", b =>
                {
                    b.HasOne("TinyFeetBackend.Entities.Order", "Order")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TinyFeetBackend.Entities.Payment", b =>
                {
                    b.HasOne("TinyFeetBackend.Entities.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("TinyFeetBackend.Entities.Payment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
